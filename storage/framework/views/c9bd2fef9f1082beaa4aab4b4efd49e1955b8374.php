...
<body > 
    ...
    border-top-right-radius: 25px  !important;  margin-top: -20px; ">  
                            ...
                            <div class="content">  
                                    <div style=" -ms-flex-wrap: wrap; flex-wrap: wrap; " class="mb-4 "> 
                                        ...
                                        <div class="col text-left mt-2 ">
                                            <a class="my-0 font-weight-normal" style="font-size: 24px; color: #000000 !important; "><b>Report Order Barang, <?php echo e($nmotl); ?> </b></a>
                                        </div>
                                        ...
                                        <div class="text-left"> 
                                            <div class="  ml-3"> 
                                                ...
                                                <a style="font-size: 20px; color:black;  padding-left:180px; padding-right:5px;"> :
                                                    <?php echo e($kdbrng); ?> / <?php echo e($whdocno); ?> 
                                                </a>
                                            </div> 
                                            <div class="  ml-3"> 
                                                ...
                                                <a style="font-size: 20px; color:black;  padding-left:180px; padding-right:5px;"> :
                                                    <?php echo e($wktorder); ?> / <?php echo e($nm_lengkap); ?> 
                                                </a>
                                            </div> 
                                            <div class="  ml-3"> 
        ...
        <a class="fixed-plugin-button text-white position-fixed px-3 py-2" href="<?php echo e(asset('public/resource/img/share.png')); ?>" download> aaaaaaaa
            <img 
            class=" shadow-sm " 
            style="width: 300px;" alt="Whatsapp" 
            src="<?php echo e(asset('public/resource/img/share.png')); ?>">   
        </a>
...
</html><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/rptorderbrg/rpt_download.blade.php ENDPATH**/ ?>