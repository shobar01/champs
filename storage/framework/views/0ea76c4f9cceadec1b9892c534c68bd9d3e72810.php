...
<script>
    function clos_tmbhpenglmn(){
      ...
      function sbt_tmbhpnglmn(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("tmbhpenglaman")); ?>',  
            data: {"_token": "<?php echo e(csrf_token()); ?>","nip":'<?php echo e($nip); ?>',"type":'Tambah',"prshn":prshn,"jbtan":jbtan,"mskrj":mskrj,"gajih":gajih,"almat":almat,
            "alsan":alsan,"nmanip":'<?php echo e($nm_lengkap); ?>' },
            dataType: 'json',
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/hris/modal/mdl_pengalman.blade.php ENDPATH**/ ?>