...
<div class="container" style="padding-top: 70px; padding-right: 5px ; padding-left: 5px; ">
    <div class="card-deck mb-3 ">
        <div class="card mb-4 shadow-sm" style="height:88vh">
            ...
            <div class="card-body">
                <form id="send_suarakaryawan" class="" action="<?php echo e(route('suara_krwn')); ?>" method="GET">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="date" name="tgl_suarakrwan" id="tgl_suarakrwan" value="<?php echo e($itgl); ?>"
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="month" id="bln_suarakrwan" name="bln_suarakrwan" min="2022-04" value="<?php echo e($ibln); ?>"
                            max="<?php echo e($maxbln); ?>" class="form-control " style="font-size: 12px; color:black;"
                    ...
                    <div class="fw-body">
                        <div class="content">
                            ...
                            <table id="tb_ordbrg" class="display nowrap " style="width:100%;  ">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $df_suarak;
    ...
    $loop = $__env->getLastLoop();?>
	                                    <tr>
	                                        ...
	                                        <td class="text-left" style="font-size: 12px !important;">
	                                            <?php echo e(Str::substr($df['nm_lengkap'], 0, 1)); ?>****
	                                        </td>
	                                        ...
	                                        <td style="font-size: 12px !important;">
	                                            <i class="fa fa-eye"
	                                                onclick="isi_suara('<?php echo e(Str::substr($df['nm_lengkap'], 0, 1)); ?>**** : <?php echo e($df['isisaran']); ?>')"></i>
	                                        </td>
...
<?php echo $__env->make('layouts.layout_presence', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/hris/suarakaryawan.blade.php ENDPATH**/?>