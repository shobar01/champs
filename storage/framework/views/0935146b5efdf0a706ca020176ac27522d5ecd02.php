                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-5 features-img">
                                        <img src="<?php echo e(asset('public/resource/img/cm/under_develop.png')); ?>" alt="" class="wow fadeInLeft"
                                    ...
                                    <footer class="page-footer font-small special-color-dark pt-4">
                                        <div class="container">
                                            <ul class="list-unstyled list-inline text-center">
                                                ...
                                                <li class="list-inline-item">
                                                    <a class="btn-floating btn-fb mx-1">
                                                        <img src="<?php echo e(asset('public/resource/img/cm/ms.png')); ?>"
                                                            class="img-circle avatar center"
                                                            style="width: 50px; height: 50px;" />
                                                    </a>
                                                </li>
...
<?php echo $__env->make('layouts.layout_presence', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views//about/cri_devlop.blade.php ENDPATH**/ ?>