                ...
                <div class="card p-2 mb-2">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-row align-items-center">
                            <div class="icon"> 
                                <img src="http://api.champ-group.com/champ_dev/asset/champs_api/images_user/<?php echo e($dfuser[0]['foto']); ?>" class="img-circle avatar center"
                                    style="width: 50px; height: 50px;" /> 
                                </div>
                            <div class="text-left col">
                                <h3 class="mb-0 font-weight-normal"><?php echo e($dfuser[0]['nm_lengkap']); ?></h3>
                                <span> <?php echo e($dfuser[0]['dept']); ?> ( <?php echo e($dfuser[0]['jnsotl']); ?> )</span>
                            </div>
                        </div> 
                    </div>  
...
<script>
    $.ajax({
        ...
        var demoParams = [ 
		{
			...
			config: {
				text: '<?php echo e($qrgnrt); ?>', // Content
				...
				//logo: "logo-transparent.png", // LOGO
				 					logo:"<?php echo e(asset('public/resource/img/champs.png')); ?>",  
				//					logoWidth:80, 
				//					logoHeight:80,
...
<?php echo $__env->make('layouts.layout_presence', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/msverification/msverification.blade.php ENDPATH**/ ?>