            ...
            <div class="card-body" style="height:80vh; overflow:scroll !important;">
                <div class="col-md-12" style="padding : 0;">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format( $json['tdlvcharge'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group mb-1">
                        ...
                        <button class="btn btn-sm btn-warning input-group-text" type="button" id="btn_tsales"
                            ...
                            Sales</button>
                        <input class="form-control form-control-sm text-right inptklmjmlbld" type="text"
                            value="Rp.<?php echo e(number_format((int)$json['tjual']+(int)$json['ttax']+(int)$json['tserv']+(int)$json['tdlvcharge'], 0, '', '.')); ?>"
                            readonly>
                    </div>
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            ...
                            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                                ...
                                <div class="col-md-12" style="padding: 0px !important;">
                                    ...
                                    <?php $__currentLoopData = $hitung; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arryht): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon3"
...
<script>
    var options = {
      series: [{
      data: [<?php $__currentLoopData = $json['jualkasir']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grpp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'<?php echo e($grpp['jmlbill']); ?>',<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]
    }],
      chart: {
      type: 'bar',
      height: 380,
    ...
    xaxis: {
      categories: [<?php $__currentLoopData = $json['jualkasir']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grpp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'<?php echo e($grpp['nama']); ?>',<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ],
    },
    yaxis: {
      labels: {
...
<?php echo $__env->make('layouts.layout_presence', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views//dfr_mobile/dfr.blade.php ENDPATH**/ ?>