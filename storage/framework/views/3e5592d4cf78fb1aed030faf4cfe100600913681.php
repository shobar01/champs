...
<div id="dpassword" class="modal1">
    ...
    class="d-none">
        <header class="imgcontainer" style="background: url(<?php echo e(asset('public/resource/img/banner_delivery.png')); ?>);
        height: 100px; border-radius: .3rem;">
            <div class="container">
                <span onclick="document.getElementById('dpassword').style.display='none'" class="close"
                    title="Close Modal">&times;</span>
                <img src="<?php echo e(asset('public/resource/img/logo.png')); ?>" class="img-circle avatar center" alt="user name"
...
<div id="modl_imei" class="modal1">
    <form id="send_gntiimei" class="modal-content1 animate" action="<?php echo e(route('master_gantiimei')); ?>" method="POST"
        class="d-none">
        <?php echo csrf_field(); ?>
...
<script>
    ...
    function jsn_gantipswrd(isitype){  
        ...
        Swal.fire({
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(url("master_resetpass")); ?>', 
                        data: {"_token": "<?php echo e(csrf_token()); ?>","pass_nip":pass_nip,"type":isitype},
                        dataType: 'json',
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/modal/m_master.blade.php ENDPATH**/ ?>