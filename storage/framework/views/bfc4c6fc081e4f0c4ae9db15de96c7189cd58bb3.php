<script>
    ...
    function ubahtgl(){
        loadingon();
        var tgl = $('#tglini').val();
        window.location.href = "<?php echo e(route('viewAddMenu')); ?>?tanggal="+tgl;
    }
    function rja(x){
        var a = x.split(',');
        var kdmenu = a[0]; 
    ...
    function hist(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("histmenu")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tanggal":tanggal},
            dataType: 'json',
    ...
    function cekdet(tgl){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("histmenu")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tanggal":tgl},
            dataType: 'json',
            success:function(data){
                loadingoff2();
                var menu = data.daftarhist;
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/addmenu/script.blade.php ENDPATH**/ ?>