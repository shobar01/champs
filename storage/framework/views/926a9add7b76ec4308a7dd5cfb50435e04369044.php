    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-3 text-center">
                <i class="fa fa-times-circle fa-2x closemod" onclick="closetgl()" style="right: -7px;top: -9px;"></i>
                <div id="bulanutama">
...
</div><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/addmenu/tglhist.blade.php ENDPATH**/ ?>