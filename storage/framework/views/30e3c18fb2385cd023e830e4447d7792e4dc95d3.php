...
<body > 
    ...
    <div class="text-center" style="  background: #cc1a0b !important ; height: 80px;" >
        <img src="<?php echo e(asset('public/resource/img/logo-cmprs.png')); ?>" style="width: 60px; height: 60px;"  >
    </div>   
                            ...
                            <div class="content">  
                                    <div style=" -ms-flex-wrap: wrap; flex-wrap: wrap; " class="mb-4 "> 
                                        ...
                                        <div class="col text-left mt-2 ">
                                            <a class="my-0 font-weight-normal" style="font-size: 26px;"><b>Report Order Barang, <?php echo e($nmotl); ?> </b></a>
                                        </div>
                                            ...
                                            <div class="input-group ">
                                                <div class="input-group-prepend">
                                                    <span class="" id="basic-addon3"
                                                        style="font-size: 20px; color:black; min-width: 220px; padding:0px"><a
                                                            style="font-size: 20px; color:black; ">Kode Order/Doc </a>
                                                    </span>
                                                </div>
                                                <a style="font-size: 20px; color:black;  padding-right:5px;"> :
                                                    <?php echo e($kdbrng); ?> / <?php echo e($whdocno); ?></a>
                                            </div>
                                        </div>   
                                        <div class="text-left mt-2 ml-3">
                                            <div class="input-group ">
                                                <div class="input-group-prepend">
                                                    <span class="" id="basic-addon3"
                                                        style="font-size: 20px; color:black; min-width: 220px; padding:0px"><a
                                                            style="font-size: 20px; color:black; ">Tgl. Order/User </a>
                                                    </span>
                                                </div>
                                                <a style="font-size: 20px; color:black;  padding-right:5px;"> :
                                                    <?php echo e($wktorder); ?> / <?php echo e($nm_lengkap); ?></a>
                                            </div>
                                        </div>   
                                        <div class="text-left mt-2 ml-3">
                                            <div class="input-group ">
                                                <div class="input-group-prepend">
                                                    <span class="" id="basic-addon3"
                                                        style="font-size: 20px; color:black; min-width: 220px; padding:0px"><a
                                                            style="font-size: 20px; color:black; ">Tgl. Datang Barang </a>
                                                    </span>
                                                </div>
                                                <a style="font-size: 20px; color:black;  padding-right:5px;"> :
                                                    <?php echo e($tglterima); ?></a>
                                            </div>
                                        </div> 
                                    </div> 
...
</html><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/rptorderbrg/headpdff.blade.php ENDPATH**/ ?>