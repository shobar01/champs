...
<script>
    ...
    function timestamp() {
        $.ajax({
            url: "<?php echo e(asset('resource/php/ajax_timestamp.php')); ?>",
    ...
    <div class="col-md-12 nav-wrapper">
        <div class="navbar-header" style="width:100%;">
            ...
            <ul class="nav navbar-nav navbar-right user-nav">
                ...
                <li class="user-name"><span><?php echo e(session('nm_lengkap')); ?></span></li>
                <li class="dropdown avatar-dropdown" style="margin-right: 20px;">
                    ...
                    ?>
                    <img src="<?php echo e('data:image/png;base64,'.session('fotoqu')); ?>" class="img-circle avatar center"
        ...
        <div class="panel" style="margin:0px 30px 0 30px;">
            <div class="panel-body">
                <div class="col-md-6 col-sm-6">
                    <h3 class="animated fadeInLeft"><?php echo e(substr(session('outlet'), 0 ,15)); ?></h3>
                    <h4 class="animated fadeInLeft"><?php echo e(substr(session('outlet'), 15).' ('.session('kd_dept').')'); ?></h4>

                    <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> <?php echo e(session('posisi')); ?>,
                        Indonesia</p>
                            ...
                            <div class="responsive-table">
                                <table id="tabel_listmenu" class="table table-striped table-bordered" width="100%"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $no = 1; ?>
                                        <?php $__currentLoopData = $arrybrgwo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--                                      <tr onclick="Click_tblmenu(this)"> -->
                                        <tr>
                                            <!--                                        <td class=" col-md-1 text-center ">--><?php //echo $no; ?>
                                            <!--</td>-->
                                            <td class=" col-md-4 text-left "><?php echo e($arry['nmbarang']); ?>

                                                (<?php echo e($arry['kdbarang']); ?>)
                                            </td>
                                            <td class=" col-md-3 text-center "><?php echo e(substr($arry['periode1'],0,5)); ?>

                                                - <?php echo e(substr($arry['periode2'],0,5)); ?>

                                            </td>
                                            <td class=" col-md-1 text-center "><?php echo e($arry['jmlawal']); ?></td>
                                            <td class=" col-md-1 text-center ">
                                                <button id="btn_done" class=" btn btn-round btn-sm btn-warning"
                                                    onclick="showmodal('<?php echo e($no); ?>,<?php echo e($arry['nmbarang']); ?>,<?php echo e($arry['kdbarang']); ?>,<?php echo e($arry['periode1']); ?>')">
                                                    <?php echo e($arry['jmltarget']); ?>/<?php echo e($arry['jmlbutuh']); ?>
                        ...
                        <div class="panel top-20">
                            <div class="responsive-table">
                                <table id="tabel_baking" class="table table-striped table-bordered" width="100%"
                                    ...
                                    <tbody>
                                        <?php $no2 = 1; ?>
                                        <?php $__currentLoopData = $arryhtmsk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arrymsk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr onclick="Click_baking(this)">
                                            <!--                                            <td class="col-md-1 text-center">--><?php //echo $no2; ?>
                                            <!--</td>-->
                                            <td class="col-md-4"><?php echo e($arrymsk['nmbarang']); ?>

                                                (<?php echo e($arrymsk['kdbarang']); ?>)</td>
                                            <td class="col-md-1 text-center"><?php echo e($arrymsk['jmlmasak']); ?></td>
                                            <td class="col-md-1 text-center"><?php echo e(Str::substr($arrymsk['wktmasak'],11)); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\champs-mobile\resources\views/dashboard.blade.php ENDPATH**/ ?>