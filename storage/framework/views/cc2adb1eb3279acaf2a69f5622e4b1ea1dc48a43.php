    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('simpan_rating')); ?>" method="POST" id="simpan_rate"> <?php echo csrf_field(); ?>
...
</div><?php /**PATH G:\ChampApplication\xampp\htdocs\champs-mobile\resources\views/ticketing/modal/rate.blade.php ENDPATH**/ ?>