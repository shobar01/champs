                                    ...
                                    <div class="card-body text-left">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" id="tx_tngktpddkn"
                                                ...
                                                <?php $__currentLoopData = $df_tkpddkn1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $df): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($df['tk_pendidikan']); ?>"
                                                    style="font-size:12px !important">
                                                    <?php echo e($df['tk_pendidikan']); ?></option>
...
<script>
    function clos_tmbhpendidikan(){
      ...
      function Jsn_Sbmtpnddkn(){ 
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("tmbhpendidikan")); ?>',  
            data: {"_token": "<?php echo e(csrf_token()); ?>","nip":'<?php echo e($nip); ?>',"type":typepdk,"tksklh":tngkt,"nmsklh":nmpdk,"lokasi":loksi,"thnjzh":thniz,"jurusn":jrsnp,
            "ktrngn":ketrg,"nmanip":'<?php echo e($nm_lengkap); ?>' },
            dataType: 'json',
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/hris/modal/mdl_pendidikan.blade.php ENDPATH**/ ?>