            ...
            <div class="modal-header"
                ...
                <span class="center" style="font-weight: 500;  margin-top: 5px;">
                    <b style="font-size: 14px;">Tambah Activity <br>
                        <a style="font-size: 12px;"><?php echo e($tanggalll); ?></a> </b>
                </span>
                                    ...
                                    <div class="card-body text-left">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" id="txactv_kdoutlet"
                                                ...
                                                <?php $__currentLoopData = $dfoffotl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $df): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($df['KdOutlet']); ?>" style="font-size:12px !important">
                                                    <?php echo e($df['NmOutlet']); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" id="txactv_jammulai"
                                                name="txactv_jam" value="<?php echo e($jamnow); ?>" min="06:00" max="00:00" required>
...
<script>
    function clos_tmbhmdlactvty(){
      ...
      function Jsn_SbmtActivty(){
        ...
        if('<?php echo e($jmlactivty); ?>' == '0'){
            tipe = 'A';
            jmlactivty = 1; 
        } else {
            tipe = 'B';
            jmlactivty = parseInt('<?php echo e($jmlactivty); ?>') + parseInt(1); 
        } 
        kdactivity  = '<?php echo e($kdactivity); ?>';
        nip         = '<?php echo e($dfuser[0]["nip"]); ?>';
        longisi     = '<?php echo e($dfuser[0]["lokasilong"]); ?>';
        latisi      = '<?php echo e($dfuser[0]["lokasilat"]); ?>';
        nmdevice    = '<?php echo e($dfuser[0]["nmdvc"]); ?>';
        iddevice    = '<?php echo e($dfuser[0]["dvcimei"]); ?>';
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("submit_tmbhactivty")); ?>', 
             // kdoutlet,tanggal,nipcek,ket,ipdb
            data: {"_token": "<?php echo e(csrf_token()); ?>","tipe":tipe,"kdactivity":kdactivity,"jmlactivty":jmlactivty,"nip":nip,"longisi":longisi,"latisi":latisi,"iddevice":iddevice,
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/cmactivity/mdl_cmtmbhactivity.blade.php ENDPATH**/ ?>