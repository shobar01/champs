        ...
        <div class="modal-content">
            <div class="modal-header"
                ...
                <span class="center" style="font-weight: 500; font-size: 20px;">
                    <b> <?php if($btn_kontak == 'R'): ?> Input Guest Reservation <?php else: ?> Input Guest <?php endif; ?> </b>
                </span>
                                                ...
                                                <td style="font-size: 12px !important; color : white; width: 48%;">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control date_interval2"
                                                            id="tx_date" name="tx_date" min="<?php echo e($date_min); ?>"
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/bukutamums/m_tmbhtamu.blade.php ENDPATH**/ ?>