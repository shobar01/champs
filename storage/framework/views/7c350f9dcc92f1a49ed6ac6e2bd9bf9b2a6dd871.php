    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('simpan_ubahstatus')); ?>" method="POST" id="simpan_terima"> <?php echo csrf_field(); ?>
...
</div><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/ticketing/modal/terima.blade.php ENDPATH**/ ?>