        ...
        <div class="card shadow-sm">
            <div class="card-body" style="padding-top: 10px !important;">
                ...
                <form id="send_viewbuktamu" class="" action=" " method="GET">
                    ...
                    <input type="hidden" name="kdoutlet" id="kdoutlet" value="<?php echo e($kdoutlet); ?>">
                    <input type="hidden" name="nmoutlet" id="nmoutlet" value="<?php echo e($nmoutlet); ?>">
                            ...
                            <td style="font-size: 12px !important; color : white; width: 48%;">
                                <div class="input-group ">
                                    ...
                                    <input type="date" name="tanggal_vbktamu" id="tanggal_vbktamu" value="<?php echo e($tgl); ?>"
                                        ...
                                        onchange="periode_tgl()" max="<?php echo e($date_max); ?>" min="<?php echo e($date_minplgtgl); ?>" required>
                                </div>
                            </td>
                                ...
                                <table id="tb_viewbktm" class="display nowrap table table-striped "
                                    ...
                                    <thead>
                                        <tr style="background: #8C5E4D;">
                                            ...
                                            <th style="font-size: 12px !important; color : white;" class="text-left">
                                                Contact</th>
                                            <?php if ($tgl == $date_min && $btn_kontak != 'T'): ?>
                                            <th style="font-size: 12px !important; color : white;" class="text-center">
    ...
    $loop = $__env->getLastLoop();?>
	                                        <tr>
	                                            ...
	                                            <td style="font-size: 12px !important;" class="text-center">
	                                                <?php echo e($dftm['urtn']); ?>x (<?php echo e($dftm['paxcu']); ?> Pax)</td>
	                                            <?php endif;?>
                                            <td style="font-size: 12px !important;" class="text-center">
                                                <?php echo e($dftm['tgl']); ?>
                                            ...
                                            <td style="font-size: 12px !important;" class="text-center">
                                                <button type="button" class="btn  btn-success btn-sm "
                                                    onclick="btn_update('<?php echo e($dftm['kontak']); ?>,<?php echo e($dftm['tgl']); ?>,<?php echo e($dftm['wkt']); ?>,<?php echo e($dftm['nmcust']); ?>,<?php echo e($dftm['urtn']); ?>,<?php echo e($dftm['meja']); ?>,<?php echo e($dftm['paxcu']); ?>,<?php echo e($dftm['tglrsr']); ?>')"
                                                    style="padding: 2px !important;
                                                    font-size: 10px !important; <?php if ($dftm['meja'] == 'F'): ?> background-color: #28a745;
                                                    <?php elseif ($dftm['meja'] == 'R'): ?> background-color:#cc1a0b; border-color: #cc1a0b; <?php else: ?> background-color:#8C5E4D; border-color: #8C5E4D;  <?php endif;?> "
                                                    <?php if ($dftm['tglrsr'] != $date_min): ?> disabled <?php endif;?>>
                                                    <i
                                                        class="<?php if ($dftm['meja'] == 'F'): ?> ion-edit <?php else: ?> ion-android-restaurant <?php endif;?> "></i>
                                                    <?php if ($dftm['meja'] == 'F'): ?> Waitinglist <?php elseif ($dftm['meja'] == 'R'): ?>
                                                    Reservation <?php else: ?> <?php echo e($dftm['meja']); ?><?php endif;?></button>
                                            </td>
                                        </tr>
                                                            ...
                                                            <tr style="background: #e89f55; height: 10px;">
                                                                <th style="font-size: 10px !important; color : white;"
                                                                    ...
                                                                    No <a style="font-size: 10px !important;"
                                                                        ...
                                                                        <?php echo e($dftm['nmcust']); ?><?php echo e($dftm['kontak']); ?> </a>
                                                                </th>
                                                                <th style="font-size: 10px !important; color : white;"
                                                                    class="text-center">
                                                                    Visit</th>
    ...
    $loop = $__env->getLastLoop();?>
	                                                            <tr>
	                                                                <td style="font-size: 10px !important;"
	                                                                    class="text-center"><?php echo e($detail['urutan']); ?>

	                                                                    <a style="font-size: 10px !important;"
	                                                                        class="text-center" hidden>
	                                                                        <?php echo e($detail['nmcust']); ?><?php echo e($detail['kontak']); ?>
...
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $dftm): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
                                            ...
                                            <td style="font-size: 12px !important;" class="text-center">
                                                <button type="button" class="btn  btn-success btn-sm "
                                                    <?php if ($dftm['meja'] == 'R'): ?> onclick="btn_nav('reservation')" <?php else: ?>
                                                    onclick="btn_update('<?php echo e($dftm['kontak']); ?>,<?php echo e($dftm['tgl']); ?>,<?php echo e($dftm['wkt']); ?>,<?php echo e($dftm['nmcust']); ?>,<?php echo e($dftm['urtn']); ?>,<?php echo e($dftm['meja']); ?>,<?php echo e($dftm['paxcu']); ?>,F')"
                                                    <?php endif;?>
                                                    style="padding: 2px !important;
                                                    font-size: 10px !important; <?php if ($dftm['meja'] == 'F'): ?> background-color: #28a745;
                                                    <?php elseif ($dftm['meja'] == 'R'): ?> background-color:#cc1a0b; border-color: #cc1a0b; <?php else: ?> background-color:#8C5E4D; border-color: #8C5E4D;  <?php endif;?> ">
...
<?php echo $__env->make('bukutamums.m_updtemeja', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    if (nmcus == "" || nowa== "") {
        ...
        $.ajax({
            ...
            data: {"_token": "<?php echo e(csrf_token()); ?>","tipe":"A","nmcust":nmcus,"kontak":nowa,"ketrngn":ketcu,"kdoutlet":kdotl,"meja":no_table,"pax_tmu":pax_tmu,"tglreservasi":txdate1},
            dataType: 'json',
...
<script>
    ...
    console.log(tanggal_vbktamu+'========='+'<?php echo e($date_min); ?>')
    // btn_kontak=F
...
<?php echo $__env->make('layouts.layout_ms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views//bukutamums/bktamums.blade.php ENDPATH**/?>