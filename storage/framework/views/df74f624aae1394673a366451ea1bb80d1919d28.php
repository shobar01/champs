                                    ...
                                    <div class="card-body text-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" id="txactv_editjamselesai"
                                                name="txactv_editjamselesai" value="<?php echo e($jamnow); ?>" min="06:00" max="00:00"
                                                required>
...
<script>
    function clos_editmdlactvty(){
      ...
      function Jsn_editSbmtActivty(){  
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("submit_editactivty")); ?>', 
             // kdoutlet,tanggal,nipcek,ket,ipdb
            data: {"_token": "<?php echo e(csrf_token()); ?>","kdactivity":kdkdactv,"urutan":urtnactv,"te_jammulai":jammactv,"te_jamselesai":jamsactv,"te_lokasi":loksactv,"longisi":longisi,"latisi":latisi,
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/cmactivity/mdl_editactivity.blade.php ENDPATH**/ ?>