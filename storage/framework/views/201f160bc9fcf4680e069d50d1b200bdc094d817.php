                                    ...
                                    <div class="card-body text-left">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" id="tx_sttkk" name="tx_sttkk"
                                                ...
                                                <?php $__currentLoopData = $df_sttsklrga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $df): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($df['kk']); ?>" style="font-size:12px !important">
                                                    <?php echo e(substr($df['kk'],2)); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tx_tglkk" name="tx_tglkk"
                                                ...
                                                style="height: 30px; font-size: 12px;" max="<?php echo e($date_max); ?>"
                                                min="<?php echo e($date_min); ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label style="font-size: 12px;">Jenis Kelamin*</label>
                                            <select class="form-control  selectpicker" id="tx_jkkk" name="tx_jkkk"
                                                data-live-search="true" required style=" font-size: 12px;">
                                                <?php $__currentLoopData = $df_jnsklmn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $df): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($df['jnsklmn']); ?>" style="font-size:12px !important">
                                                    <?php echo e(substr($df['jnsklmn'],2)); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" id="tx_tngktpddknkk"
                                                ...
                                                <?php $__currentLoopData = $df_tngktpddkn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $df): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($df['pddkn']); ?>" style="font-size:12px !important">
                                                    <?php echo e($df['pddkn']); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class=" form-group">
...
<script>
    ...
    function clos_tmbhkk(){
      ...
      function Jsn_Sbmtkk(){ 
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("tmbhkk")); ?>',  
            data: {"_token": "<?php echo e(csrf_token()); ?>","nip":'<?php echo e($nip); ?>',"type":tx_type,"ktpkk":ktpkk2,"nikkk":nikkk2,"anggt":anggt2,"stskl":stskl2,"jklmn":jklmn2,
            "umurk":umurk2,"pddkn":pddkn,"almat":almat2,"tplhr":tplhr2,"tglhr":tglhr2,"tlpon":tlpon2,"nmanip":'<?php echo e($nm_lengkap); ?>' },
            dataType: 'json',
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/hris/modal/mdl_kk.blade.php ENDPATH**/ ?>