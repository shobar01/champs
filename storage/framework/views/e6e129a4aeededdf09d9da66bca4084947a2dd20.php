...
$loop = $__env->getLastLoop();?>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control" name="toglekdorgbrg" id="toglekdorgbrg" onchange="pilihkdorgbrg()">
                            <?php $__currentLoopData = $dfkdbrng;
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $dfbrg): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
	                            <option value="<?php echo e($dfbrg['kdordbarang']); ?>" <?php if ($kdbrng == $dfbrg['kdordbarang']): ?> selected
	                                <?php endif;?>>
                                <?php echo e($dfbrg['kdordbarang']); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/rptorderbrg/rptorderbrgg.blade.php ENDPATH**/?>