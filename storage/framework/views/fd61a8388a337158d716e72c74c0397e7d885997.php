...
<div class="container" style="padding-top: 90px; padding-right: 0px; padding-left: 0px;">
    <div class="card-deck mb-3 ">
        <div class="card mb-4 shadow-sm">
            <div class="card-header">
                <a class="my-0 font-weight-normal" style="font-size: 14px;"><b>Daily Sales Report
                        (<?php echo e($json['nodfr']); ?>)</b></a>
            </div>
            <div class="card-body">
                <div class="col-md-12" style="padding : 0;">
                    <form action="<?php echo e(route('dfr_mobile')); ?>" method="GET" id="formotl"
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control form-control-sm " name="toglekdotl" id="toglekdotl"
                                style=" font-weight: bold; color:black;" onchange="pilihkdotl()">
...
$loop = $__env->getLastLoop();?>
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="tgl" id="tgl" value="<?php echo e($tgl); ?>" class="form-control date_now"
                                    style="font-size: 14px; color:black;  font-weight: bold;" onchange="pilihkdotl()"
                                    required>
                            </div>
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control form-control-sm text-right inptklmjmlbld" type="text"
                            value="Rp.<?php echo e(number_format($json['target'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group mb-1">
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['akmjual'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon3"
                        ...
                        <input class="form-control form-control-sm text-right inptklmjmlbld" type="text"
                            value="Rp.<?php echo e(number_format($json['tjual'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon3"
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['tserv'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon3"
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['ttax'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon3"
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['tdlvery'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group mb-1">
                        ...
                        <button class="btn btn-sm btn-warning input-group-text" type="button" id="btn_tsales"
                            ...
                            Sales</button>
                        <input class="form-control form-control-sm text-right inptklmjmlbld" type="text"
                            value="Rp.<?php echo e(number_format((int) $json['tjual'] + (int) $json['ttax'] + (int) $json['tserv'] + (int) $json['tdlvery'], 0, '', '.')); ?>"
                            readonly>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['ttunai'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <button class="btn btn-sm btn-warning input-group-text" type="button" id="btn_tkartu"
                            ...
                            onclick="detcard()">Non
                            Tunai<a style="font-size: 8px; padding-top: 3px; color: red;">&nbsp;*<?php echo e($json['jbkartu']); ?>

                                Terpakai</a></button>
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['tkartu'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <button class="btn btn-sm btn-warning input-group-text" type="button" id="btn_tvoucher"
                            style="font-size: 14px; color:black;  min-width: 150px;  font-weight: bold; border: 1px solid #ced4da; padding-left: 10px !important;"
                            onclick="detvoucher()">Voucher<a
                                style="font-size: 8px; padding-top: 3px; color: red;">&nbsp;*<?php echo e($json['jbvoucher']); ?>

                                Terpakai</a></button>
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['tvoucher'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        ...
                        <button class="btn btn-sm btn-warning input-group-text" type="button" id="btn_tdiskon"
                            ...
                            onclick="detdiskon()">Diskon<a
                                style="font-size: 8px; padding-top: 3px; color: red;">&nbsp;*<?php echo e($json['jbdiskon']); ?>

                                Terpakai</a></button>
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['tdiskon'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="Rp.<?php echo e(number_format($json['expense'], 0, '', '.')); ?>" readonly>
                    </div>
                    <div class="input-group mb-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon3"
                        ...
                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
                            value="<?php echo e(number_format((int) $json['tcup'] + (int) $json['tcuw'], 0, '', '.')); ?> Customer"
                            readonly>
                    </div>
                            ...
                            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                                ...
                                <div class="col-md-12" style="padding: 0px !important;">
                                    ...
                                    <?php $__currentLoopData = $hitung;
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $arryht): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>
	                                    <div class="input-group">
	                                        <div class="input-group-prepend">
	                                            <span class="input-group-text" id="basic-addon3"
	                                                style="font-size: 14px; color:black;  min-width: 150px;"><b><?php echo e($arryht['fmja']); ?></b>
	                                                <a style="font-size: 8px; padding-top: 3px; color: red;">&nbsp;*<?php echo e($arryht['fbanyak']); ?>

	                                                    Transaksi</a>
	                                            </span>
	                                        </div>
	                                        <input class="form-control form-control-sm text-right inptklmjml" type="text"
	                                            value="Rp.<?php echo e(number_format($arryht['fjual'], 0, '', '.')); ?>" readonly>
	                                    </div>
	                                    <?php endforeach;
$__env->popLoop();
$loop = $__env->getLastLoop();?>
                ...
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    ...
                    <div class="col-md-12" style="padding: 0px !important;">
                        <div class="card-header text-center">
                            ...
                            <button class=" col-md-12 btn btn-lg btn-primary btn-rounded mb-1 mt-2" type="button"
                                style="font-size: 14px; color:white;  min-width: 150px;  font-weight: bold; padding-left: 10px !important; "
                                onclick="detmenuterjual()">Menu Terjual</button>
                        </div>
                    </div>
                </div>
                <?php endif;?>
...
<?php if (isset($json['kdoutlet'])): ?>
<?php echo $__env->make('dfr_mobile.modal.detaildfr.card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('dfr_mobile.modal.detaildfr.voucher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('dfr_mobile.modal.detaildfr.diskon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('dfr_mobile.modal.detaildfr.expanse', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('dfr_mobile.modal.detaildfr.menuterjual', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('dfr_mobile.modal.detaildfr.noorder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif;?>
...
<script>
    var options = {
      series: [{
      data: [<?php $__currentLoopData = $json['jualkasir'];
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $grpp): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>'<?php echo e($grpp['jmlbill']); ?>',<?php endforeach;
$__env->popLoop();
$loop = $__env->getLastLoop();?>]
    }],
      chart: {
    ...
    xaxis: {
      categories: [<?php $__currentLoopData = $json['jualkasir'];
$__env->addLoop($__currentLoopData);foreach ($__currentLoopData as $grpp): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop();?>'<?php echo e($grpp['nama']); ?>',<?php endforeach;
$__env->popLoop();
$loop = $__env->getLastLoop();?>
      ],
    },
    ...
    title: {
        text: 'Jumlah Transaksi <?php echo e($json['tbill']); ?>',
        align: 'center',
        floating: true
    },
    subtitle: {
...
<script>
    function detmenuterjual(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("dfrmenuterjual")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tanggal":tanggal,"kdotl":kdotll},
            dataType: 'json',
    ...
    function detcard(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("dfrdet")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tipe":"B","tanggal":tanggal,"kdotl":kdotll,"wktawal":wktawal,"wktakhir":wktakhir},
            dataType: 'json',
    ...
    function detvoucher(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("dfrdet")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tipe":"E","tanggal":tanggal,"kdotl":kdotll,"wktawal":wktawal,"wktakhir":wktakhir},
            dataType: 'json',
            success:function(datas){
                // console.log(datas);
                $('#loader').hide();
    ...
    function detdiskon(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("dfrdet")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tipe":"C","tanggal":tanggal,"kdotl":kdotll,"wktawal":wktawal,"wktakhir":wktakhir},
            dataType: 'json',
            success:function(datas){
                // console.log(datas);
                $('#loader').hide();
    ...
    function detexpanse(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("dfrdet")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tipe":"D","tanggal":tanggal,"kdotl":kdotll,"wktawal":wktawal,"wktakhir":wktakhir},
            dataType: 'json',
            success:function(datas){
                // console.log(datas);
                $('#loader').hide();
                ...
                if(banyakexpense > 0){
                    for (let i = 0; i < lenexpense; i++) {
                        ...
                        var rowexpense = '<li class="shadow p-2 mb-3 bg-white rounded" style="box-shadow: 0 0.5rem 0.5rem rgb(0 0 0 / 15%) !important;">'
                            ...
                            +'</span>'
                            +'</div>'
                            +'<a style="font-size: 12px; color:black; "><b> : '+barket.substring(0, 40)+'</b></a>'
                            +'</div>'
                            +'</li>';
...
<script>
    ...
    function pilihdfr(tipe){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("dfrdet")); ?>',
            data: {"_token": "<?php echo e(csrf_token()); ?>","tipe":tipe,"tanggal":tanggal,"kdotl":kdotll,"wktawal":wktawal,"wktakhir":wktakhir},
            dataType: 'json',
            success:function(datas){
...
<script>
    var options = {
          series: [<?php echo e($json['pssales']); ?>, <?php echo e($krgpssales); ?>],
          chart: {
          width: 380,
          type: 'pie',
        },
...
<?php echo $__env->make('layouts.layout_cmdash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\champs-mobile\resources\views//dfr_mobile/dfr.blade.php ENDPATH**/?>