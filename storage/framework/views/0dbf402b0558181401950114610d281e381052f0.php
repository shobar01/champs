...
<script>
    function Mjsn_sbmtupdt(isi){ 
        ...
        $.ajax({
            ...
            data: {"_token": "<?php echo e(csrf_token()); ?>","kdotl":kdotlmj,"kdakses":'<?php echo e($kdakses); ?>',"nomeja":nmeja,"kapasitas":kpsts,"smokarea":smoke,"tippe":'B'},
            dataType: 'json',
...
</script><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/mssettingmeja/m_upmeja.blade.php ENDPATH**/ ?>