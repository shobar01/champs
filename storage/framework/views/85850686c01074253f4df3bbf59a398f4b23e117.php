...
<body id="mimin">
    ...
    <nav class=" header  fixed-top" style="height: 30px !important; padding: 30px 0 30px 0 !important;">
        <div class="mx-auto my-2 order-0 order-md-1 position-relative topheader">
    ...
    <footer class="footer " id="id_footerr">
        <div class="row">
            <div class="input-group">
                ...
                <div class=" col copyright text-right mr-2" style="font-size: 10px;">©ICT Department 2022 -
                    Version
                    1.2
                </div>
            </div>
...
</html><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/layouts/layout.blade.php ENDPATH**/ ?>