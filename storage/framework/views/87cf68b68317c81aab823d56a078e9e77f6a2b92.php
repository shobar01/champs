<div class="modal fade" id="befoto" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header color-card" style="padding: 12px 12px 0 12px;border:0;">
                ...
                <button type="button" class="close" onclick="closebukafoto()">&times;</button>
            </div>
            <div class="modal-body p-0 color-card">
                <div class="display-cover">
                    <video autoplay id="video" width="340" height="450" muted></video>
                    <canvas class="d-nones" id="canvas3"></canvas>
                    ...
                    <div class="controls">
                        ...
                        <button class="btn btn-outline-success screenshot pulsate-fwd" title="ScreenShot"
                            style="padding:10px;position:absolute;right: 10px;bottom: 0;background: white;"><i
...
</div><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/backend/modal/mdfoto2.blade.php ENDPATH**/ ?>