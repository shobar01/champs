    ...
    <div class="card-deck mb-3 ">
        <div class="card shadow-sm" style="height:auto">
            ...
            <div class="card-body">
                ...
                <form id="send_adjust" class="" action="<?php echo e(route('adjustms')); ?>" method="GET">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="input-group ">
                        ...
                        <input type="date" name="tgl_noorder" id="tgl_noorder" value="<?php echo e($itgl); ?>"
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="inpt_noorder" name="inpt_noorder" class="form-control "
                            value="<?php echo e($noorder); ?>" style="font-size: 12px; color:black;" onkeypress="inptnenter_noorder()"
                        ...
                        <ul id="nav-tab" style="overflow-x: hidden; list-style-type: none; padding: 5px;">
                            <li id="ii'+noorder" class="bg-white rounded ">
                                ...
                                <div class="card-header text-center mb-1" style=" padding:5px !important;"><a
                                        style="font-size: 14px; color:black;"><b><?php echo e($noorder); ?>

                                            (<?php echo e($jsrslt['nomeja']); ?>)</b></a>
                                </div>
                                ...
                                <div class="shadow-lg rounded-2 bg-white p-1">
                                    <div class="input-group ">
                                        ...
                                        <a style="font-size: 12px; color:black;"><b> &nbsp; <?php echo e($jsrslt['nama']); ?>-
                                                <?php echo e($jsrslt['nipkasir']); ?></b></a>
                                    </div>
                                    <div class="input-group mb-1">
                                        ...
                                        <a style="font-size: 12px; color:black;"><b> &nbsp;
                                                <?php echo e($jsrslt['tglposting']); ?></b></a>
                                ...
                                <div class="table-responsive" style="overflow-x: hidden">
                                    <div class="table-responsive" style="overflow-x: hidden; height: 250px; ">
                                        <table id="tbllogkredit" class="table table-striped"
                                            ...
                                            <?php $__currentLoopData = $jsrslt['detail']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dfdet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="height:30px">
                                                <td class="ftsize12l" width="70%"><?php echo e($dfdet['mnn']); ?></td>
                                                <td class="ftsize12r" width="5%"> x<?php echo e($dfdet['qtyjual']); ?></td>
                                                <td class="ftsize12r text-right" width="25%">
                                                    <?php echo e(number_format($dfdet['tts'], 0, '', '.')); ?></td>
                                            </tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th class="text-right py-0"
                                        ...
                                        <?php echo e(number_format($jsrslt['jmljual'], 0, '', '.')); ?>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right py-0"
                                        style="font-size: 12px; color: black; padding-right: 5px; width: 30%;">
                                        <?php echo e(number_format($jsrslt['jmlserv'], 0, '', '.')); ?></th>
                                </tr>
                                <tr>
                                    ...
                                    <th class="text-right py-0"
                                        style="font-size: 12px; color: black; padding-right: 5px; width: 30%;">
                                        <?php echo e(number_format($jsrslt['jmltax'], 0, '', '.')); ?>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right py-0"
                                        ...
                                        Rp. <?php echo e(number_format($jsrslt['jmljual']+$jsrslt['jmltax']+$jsrslt['jmlserv'], 0,
                                        '', '.')); ?>
...
<script>
    function btnjsn_adjust(){  
        ...
        var inpt_nor =   $("#inpt_noorder").val();
        Swal.fire({
                    text: "Apakah anda (<?php echo e($nip); ?>) yakin akan Merubahnya?",
                    icon: 'warning',
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(url("submit_adjust")); ?>', 
                        data: {"_token": "<?php echo e(csrf_token()); ?>","nip":'<?php echo e($nip); ?>',"inpt_tgl":inpt_tgl,"inpt_nor":inpt_nor},
                        dataType: 'json',
...
<?php echo $__env->make('layouts.layout_presence', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ChampApplication\xampp\htdocs\api\champs-mobile\resources\views/msadjust/adjust.blade.php ENDPATH**/ ?>