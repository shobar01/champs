    ...
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center">
            <div class="modal-content">
                <form id="send_mdllstmenu" action="{{route('dashboard_addlstmenu')}}" method="POST" class="d-none">
                    @csrf
                    ...
                    <div class="modal-footer">
                        {{-- <button class="btn-flip btn btn-raised btn-primary"> --}}
                        {{-- <div class="side" href="{{ route('dashboard_addlstmenu') }}"
                        onclick="event.preventDefault();
                        document.getElementById('send_mdllstmenu').submit();">
