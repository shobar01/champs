...
<div class="container" style="padding: 70px 0 0 0;">
    <div class="card-deck mb-3 ">
        <div class="card mb-12 shadow-sm">
            ...
            <form action="{{route('simpanimprt')}}" method="POST" id="formotl" style="margin-bottom: 3px !important;"
                    ...
                    <div class="col-md-12" style="padding : 0;">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control form-control-sm  font-weight-bold" type="text"
                                value="@if(isset($kdotl)){{$nmotl}} ({{$kdotl}})@endif"
                            ...
                            <input id="tx_kdotl" name="tx_kdotl" class="form-control form-control-sm  font-weight-bold"
                                type="hidden" value="@if(isset($kdotl)){{$kdotl}}@endif"
                                style="font-size: 14px; color:black;" readonly>
                        </div>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            ...
                            <input id="tx_tgl" name="tx_tgl" class="form-control form-control-sm font-weight-bold "
                                type="text" value="@if(isset($tanggal)){{$tanggal}} @endif"
                                style="font-size: 14px; color:black;" readonly>
                        </div>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            ...
                            <input id="tx_nip" name="tx_nip" class="form-control form-control-sm font-weight-bold "
                                type="hidden" value="@if(isset($nip)){{$nip}}@endif"
                                style="font-size: 14px; color:black;" readonly>
                            <input id="tx_nmnip" name="tx_nmnip" class="form-control form-control-sm font-weight-bold "
                                type="text" value="@if(isset($nama)){{$nama}} ({{$nip}})@endif"
                                style="font-size: 14px; color:black;" readonly>
                        </div>
                        @endif
                                ...
                                <div class="table-responsive" style="overflow-x: hidden">
                                    ...
                                    <div class="table-responsive" style="overflow-y: hidden;">
                                        <table id="tblcogs" class="table table-striped table-bordered"
                                            ...
                                            <tbody id="tbcogs">
                                                @if(isset($hasilimprt))
                                                @foreach ($hasilimprt as $dfh)
                                                <tr>
                                                    @if ( is_numeric($dfh[0]) == true ) <td class="ftsize12l aaa">
                                                        <input type="hidden" id='urutan{{$dfh[0]}}' name="urutan[]"
                                                            value="{{$dfh[0]}}">
                                                        {{$dfh[0]}}
                                                    </td>
                                                    <td class="ftsize12l aaa">
                                                        {{ucwords(strtolower($dfh[2])) }}
                                                    </td>
                                                    <td class="ftsize12l "> <input type="hidden" id='kdbrg{{$dfh[1]}}'
                                                            name="kdbrg[]" value="{{$dfh[1]}}">{{$dfh[1]}}</td>
                                                    </td>
                                                    <td class="ftsize12l ">
                                                        <input type="hidden" id='satuan{{$dfh[3]}}' name="satuan[]"
                                                            value="{{$dfh[3]}}">{{$dfh[3]}}
                                                    </td>
                                                    </td>
                                                    <td class="ftsize12l ">
                                                        <input type="hidden" id='jumlah{{$dfh[4]}}' name="jumlah[]"
                                                            value="{{$dfh[4]}}">{{$dfh[4]}}
                                                    </td>
                                                    </td>
                                                    @endif
...
<div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('importstkcc') }}" method="POST" enctype="multipart/form-data">
                @csrf
