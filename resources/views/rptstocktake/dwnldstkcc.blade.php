        ...
        <div class="card mb-12 shadow-sm">
            ...
            <div class="card-body" style="padding : 0.55rem !important;">
                <div class="col-md-12" style="padding : 0;">
                    ...
                    <form action="{{ route('exportstkcc') }}" method="GET" id="formotl"
                        ...
                        <div class="input-group">
                            ...
                            <input type="hidden" name="nmotl" id="nmotl" value="{{$nmotl}}">
                            ...
                            <select class="form-control form-control-sm " name="toglekdotl" id="toglekdotl"
                                ...
                                <option value="{{$otl['nmoutlet']}},{{$otl['kdoutlet']}}" @if ($kdotl==$otl['kdoutlet']
                                    ) selected @endif>
