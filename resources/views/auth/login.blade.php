...
<head>
    ...
    <link href="{{asset('public/resource/css/loader2.css')}}" rel="stylesheet" />

    <link rel="stylesheet" href="{{asset('public/resource/logins/css/style.css')}}">
...
<body class="img js-fullheight"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <div class="img text-center">
                            <img src="{{asset('public/resource/img/logo.png')}}" alt="" width="50%">
                        </div>
                        <form action="{{route('loginApp')}}" method="POST">@csrf
                ...
                <div class="container" style="margin-top: 20px;">
                    <div class="container">
                        <ul class="list-unstyled list-inline text-center">
                            ...
                            <li class="list-inline-item">
                                <a>
                                    <img src="{{asset('public/resource/img/LogoMS1.png')}}"
                                        class="img-circle avatar center" style="width: 50px; height: 50px;" />
                                </a>
                            </li>
                        </ul>
    ...
    <script src="{{asset('public/resource/logins/js/jquery.min.js')}}"></script>
    <script src="{{asset('public/resource/logins/js/popper.js')}}"></script>
    <script src="{{asset('public/resource/logins/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('public/resource/logins/js/main.js')}}"></script>
