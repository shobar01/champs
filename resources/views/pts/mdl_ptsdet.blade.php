...
<div id="mdl_detailpts" class="modal">
    <div class="" style="height: 100%; max-width: 100% !important; margin-top:60px; ">
        <div class="modal-content animate" style="">
            ...
            <form id="form_approval" action="{{route('simpan_approval')}}" method="POST" enctype="multipart/form-data" onkeypress="return event.keyCode !=13">
                @csrf  
                
                <input type="hidden" name="tgl_returptsdet" id="tgl_returptsdet" value="{{$plhtgl}}"   required> 
                <input type="hidden" id="nipdet" name="nipdet" value="{{$nip}}"/>
                <input type="hidden" id="kdaksesdet" name="kdaksesdet" value="{{$kdakses}}"/>
