        ...
        <div class="card shadow-sm" style="height:auto">
            ...
            <div class="card-body">
                <form id="send_approvpts" class="" action="#" method="GET">
                    ...
                    <input type="text" id="kdakses" name="kdakses" value="{{$kdakses}}" hidden />
                    ...
                    <div class="input-group mb-2 mt-1 px-1">
                        ...
                        <input type="date" name="tgl_returpts" id="tgl_returpts" value="{{$plhtgl}}"
                ...
                <ul style="overflow-x: hidden; height: 70vh; list-style-type: none; padding: 5px;" id="ul_dflist1">
                    ...
                    @foreach ($jsdfpts as $df)
                    <li class="shadow p-1 mb-1 bg-white rounded "
                        onclick="btn_detailapprovalpts('{{$df['kdretur']}}#{{$df['nmoutlet']}}#{{$df['updateqa']}}')">

                        <div class="card  my-1 " style="margin-bottom:0px !important;">

                            <div class="btn-sm">
                                <label class="badge " style="padding: 0.4em 0.2em !important; position: absolute; left: 0; top: -1px; width:20px;  @if ($df['updateqa'] === 'F' || $df['updateqa'] === null )
                                    background-color: #cc1a0b;
                                    line-height:76px;
                                    @else background-color: #28a745;line-height:92px; @endif">
                                ...
                                <div class="ml-4">
                                    <div class="text-left">
                                        <div class="input-group ">
                                            ...
                                            <a style="font-size: 12px; color:black;  padding-right:5px;"> :
                                                @if (strlen($df['nmoutlet']) > 25 )
                                                {{substr($df['nmoutlet'], 0, 23)}}...
                                                @else {{substr($df['nmoutlet'], 0, strlen($df['nmoutlet']))}} @endif
                                            </a>
                                        </div>
                                    </div>
                                    <div class="text-left">
                                    ...
                                    @if ($df['updateqa'] === 'F' || $df['updateqa'] === null )
                                    <div class="text-left">
                                        <div class="input-group ">
                                            <div class="input-group-prepend">
                                                <span class="" id="basic-addon3"
                ...
                <ul style="overflow-x: hidden; height: 70vh; list-style-type: none; padding: 5px;" id="ul_dflist2">
                    ...
                    <li class="shadow p-1 mb-1 bg-white rounded "
                        ...
                        <div class="card  my-1 " style="margin-bottom:0px !important;">
                            ...
                            <div class="btn-sm">
                                <label class="badge " style="padding: 0.4em 0.2em !important; position: absolute; left: 0;line-height:76px; top: -1px; width:20px;  @if ($df['updateqa'] === 'F' || $df['updateqa'] === null )
                                    background-color: #cc1a0b;
                        ...
                        <div class="content">
                            <div class="card-deck mb-3 ">
                                <div class="card mb-4 shadow-sm">
                                    ...
                                    <form id="send_ptsdwnld" class="" action="{{ route('pts_approvalqa') }}"
                                        method="GET">
                                        @csrf
                                        <div class="card-body text-left">
                                            <div class="input-group mb-3">
                                                <input type="month" id="bln_dwldpts" name="bln_dwldpts"
                                                    min="{{$minbln}}" value="{{$nowbln}}" max="{{$nowbln}}"
...
@include('pts.mdl_ptsdet')
@include('pts.mdl_updateketqa')
<script>
...
<script>
    ...
    function btn_detailapprovalpts(isi){   
        ...
        $.ajax({
            type: 'POST',
            url: '{{url("pts_approvalqadet")}}',  
            data: {"_token": "{{ csrf_token() }}","plhtgl":tgl_returpts,"kdretur":kdretur},
            dataType: 'json',
