    ...
    <div class=" w3-animate-bottom fixed-bottom m-0" role="document">
        <div class="modal-content animatecolor-card">
            ...
            <div class="modal-body pt-0">
                ...
                {{-- <div class="table-responsive" style="overflow-x: hidden; height: 50px;">

                    <div class="table-responsive" style="overflow-y: hidden;">
                        <table id=" " class="table" style="min-width: 600px !important;">
                            <thead>
                                <th class="ftsize12 aaa thkuning" style="height: 20px ;">Nomor Order</th>
                                <th class="ftsize12l thkuning">Kode Kartu</th>
                                <th class="ftsize12l thkuning">Nominal</th>
                                <th class="ftsize12l thkuning">Potongan</th>
                            </thead>

                            <tbody id="detailkartu">
                            </tbody>
                        </table>
                    </div>
                </div> --}}
