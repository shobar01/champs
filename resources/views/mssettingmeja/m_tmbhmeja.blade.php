        ...
        <div class="modal-content animate">
            <div class="modal-header"
                ...
                <span class="center" style="font-weight: 500; font-size: 14px; margin-top: 5px;">
                    <b id="tx_ketupmeja">Tambah Meja 0{{count($df_meja)+1}} </b>
                </span>
                                ...
                                <div class="content">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="tx_tbhnomeja" id="tx_tbhnomeja"
                                            value="0{{count($df_meja)+1}}" class="form-control"
                                        ...
                                        <div class="input-group">
                                            ...
                                            {{-- <input type="number" name="tx_tbhkpsts" id="tx_tbhkpsts" value=""
...
<script>
    ...
    function Jsn_sbmttmbh(){
        ...
        $.ajax({
            ...
            data: {"_token": "{{ csrf_token() }}","kdotl":kdotlmj,"kdakses":'{{$kdakses}}',"nomeja":nmeja,"kapasitas":kpsts,"smokarea":smoke,"tippe":'C'},
            dataType: 'json',
