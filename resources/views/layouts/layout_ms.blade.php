...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('public/resource/img/logosplash.png')}}">
    ...
    <link href="{{asset('public/resource/css/style_ms.css')}}" rel="stylesheet" type="text/css">
    ...
    <link href="{{asset('public/resource/css/stylesapexcharts.css')}}" rel="stylesheet" type="text/css">
    ...
    {{-- select search --}}
    {{--
    <link href="{{asset('public/resource/css/selectsearch.min.css')}}" rel="stylesheet">

    <script src="{{asset('public/resource/js/bootstrap-select.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/resource/js/selectsearch.min.js')}}"></script> --}}
    ...
    <!--    Keyboard-->
    <link rel="stylesheet" href="{{asset('public/resource/keyboard/dist/virtual-keyboard.css')}}">
    <script src="{{asset('public/resource/keyboard/dist/virtual-keyboard.min.js')}}"></script>
...
<body class="dashboard" style="background-color: #f0f3f4 !important; overflow: hidden; height: 100vh; ">
        ...
        <nav class="navbar navbar-icon-top navbar-expand-sm  fixed-top"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="nav-item" id="li_logo">
                    <img src="{{asset('public/resource/img/logoMS1.png')}}" class="img-circle avatar center "
    ...
    <footer class="footer fixed-bottom" id="id_footerr" style="padding-bottom: 5px !important;">
        ...
        {{-- <span class="copyright">Version 1.1</span> --}}
    </footer>
