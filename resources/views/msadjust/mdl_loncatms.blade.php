                                ...
                                <div class="card mb-4 shadow-sm"> 
                                    <div class="card-body text-left"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tglloncat" id="tglloncat" value="{{$tgl}}" class="form-control date_now"
    ...
    function submitt_lnctms(){ 
        ...
        function btnjsn_lnctclos(){  
            ...
            var tglloncat = $('#tglloncat').val();
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{url("adjst_loncatclosing")}}', 
                        data: {"_token": "{{ csrf_token() }}","kdoutlet":toglekdotl,"tglloncat":tglloncat},
                        dataType: 'json',
