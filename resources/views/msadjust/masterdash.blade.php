                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex flex-row align-items-center">
                                        <div class="icon"> 
                                            ...
                                            <img src="http://api.champ-group.com/ptsoutlet/public/assets/img/mspik.jpg" class="img-circle center rdimg"/>
                                            {{-- <img src="http://api.champ-group.com/champs-mobile/public/resource/img/cm/loncatclosing.png" class="img-circle center rdimg"/>  --}}
                                            </div>
                                        <div class="ml-2 c-details">
...
@include('msadjust.mdl_addbrgms')
{{-- @include('msadjust.mdl_switch') --}}
@include('msadjust.mdl_loncatms')
...
<script>
    $.ajax({
        ...
        function btn_link(isi){ 
            var linkkk ;
             if(isi == 'ms'){
                linkkk = "http://api.champ-group.com/champs-mobile/adjustms?kdakses={{$kdakses}}&nip={{$nip}}";
             }else if(isi == 'ds'){
                linkkk = "http://api.champ-group.com/champs-mobile/adjustds?kdakses={{$kdakses}}&nip={{$nip}}";
             }else if(isi == 'md'){
                linkkk = "http://api.champ-group.com/champs-mobile/master?kdakses={{$kdakses}}&nip={{$nip}}";
             }else if(isi == 'ft'){
                linkkk = "http://api.champ-group.com/new_posmobile/DashHome?kdakses={{$kdakses}}&nip={{$nip}}";
             } else if(isi == 'sw'){
                linkkk = "http://api.champ-group.com/champs-mobile/masterswitch?kdakses={{$kdakses}}&nip={{$nip}}";
             }  else if(isi == 'ad'){
                linkkk = "http://api.champ-group.com/champs-mobile/viewAddMenu?kdakses={{$kdakses}}&nip={{$nip}}";
             } 
