        ...
        <div class="modal-content animate">
            {{-- <div class="modal-header"
                ...
                <span class="center" style="font-weight: 500;  margin-top: 8px;">
                    <b style="font-size: 14px;">Tambah Pengalaman </b>
                </span>

                <i class="ion-close-circled end-0" style="color: red;   font-size: 25px;" onclick="clos_waiting()"
                    class="close"></i>
            </div> --}}
          ...
          var pddkn_type = $('#pddkn_type').val();   
            Swal.fire({
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '{{url("btlknppk")}}',   
                            data: {"_token": "{{ csrf_token() }}","kdupdpeg":kdupdpeg},
                            dataType: 'json',
